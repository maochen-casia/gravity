...
class DPTHead(nn.Module):
    def __init__(
        ...
        self.scratch.output_conv2 = nn.Sequential(
            nn.Conv2d(head_features_1 // 2, final_out_channels, kernel_size=3, stride=1, padding=1),
            nn.ReLU(True),
            nn.Conv2d(final_out_channels, final_out_channels, kernel_size=1, stride=1, padding=0)
        )
